...
import CategoryMenuButton2 from "@/components/header/CategoryMenuButton2";

const CategoryMenuButton1 = ({ categories }: { categories: string[] }) => {
...
export default CategoryMenuButton1;
